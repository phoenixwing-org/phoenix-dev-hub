...
<style scoped>
.admin-plugin-view { width: 100%; height: 100%; --pnw-page-main-block-padding: 20px 24px 36px; --pdh-header-control-height: calc(var(--pnw-workbench-view-header-height, 40px) - 8px); color: var(--pnw-workbench-text, var(--pnw-workbench-default-text, #0f172a)); background: var(--pnw-workbench-bg, var(--pnw-workbench-default-bg, #f8fafc)); }
...
:deep(.pnw-head-actions > button) { min-height: var(--pdh-header-control-height); padding: 0 10px; line-height: 1; }
